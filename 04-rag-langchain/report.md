...
**Вариант:** **AIDD** — бот развивается итерационно (AI-driven, 29 итераций по `docs/tasklist.md`), является продолжением проекта «Ника» из модулей М02–М03. Модуль М04 (RAG + LangChain) добавлен к уже работающему мультимодальному ассистенту.
