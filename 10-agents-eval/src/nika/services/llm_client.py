...
а также заказ расходников («закажи полоски Contour на имя IVAN PETROV») — это не еда \
и не справочный вопрос по PDF.
...
Заказ расходников / полосок / сенсоров — should_log=false, is_reference_question=false.
...
- «Закажи полоски Contour на имя IVAN PETROV» → should_log=false, \
is_reference_question=false
- «Зарегистрируй сенсор Libre 3 на имя IVAN PETROV» → should_log=false, \
is_reference_question=false
